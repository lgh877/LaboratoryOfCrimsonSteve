...
import net.mcreator.laboratory.entity.renderer.BigGuyRenderer;
import net.mcreator.laboratory.LaboratoryModElements;

@LaboratoryModElements.ModElement.Tag
public class BigGuyEntity extends LaboratoryModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.3f, 3.5f)).build("big_guy").setRegistryName("big_guy");

	public BigGuyEntity(LaboratoryModElements instance) {
		super(instance, 72);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BigGuyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13434880, new Item.Properties().group(MobsOfLaboratoryItemGroup.tab))
				.setRegistryName("big_guy_spawn_egg"));
	}
