...
public class StevotEntity extends LaboratoryModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("stevot").setRegistryName("stevot");

	public StevotEntity(LaboratoryModElements instance) {
		super(instance, 65);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StevotRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		private LivingEntity higherPart;
		private UUID higherPartUuid;

		public void readAdditional(CompoundNBT compound) {
			super.readAdditional(compound);
			if (compound.hasUniqueId("Owner")) {
				this.higherPartUuid = compound.getUniqueId("Owner");
			}
		...
		public void writeAdditional(CompoundNBT compound) {
			...
			if (this.higherPartUuid != null) {
				compound.putUniqueId("Owner", this.higherPartUuid);
			}
			//compound.putFloat("PartAngle", angleYaw);
			//compound.putFloat("PartRadius", radius);
		}

		public void setHigherPart(@Nullable LivingEntity p_190549_1_) {
			this.higherPart = p_190549_1_;
			this.higherPartUuid = p_190549_1_ == null ? null : p_190549_1_.getUniqueID();
		}

		@Nullable
		public LivingEntity getHigherPart() {
			if (this.higherPart == null && this.higherPartUuid != null && this.world instanceof ServerWorld) {
				Entity entity = ((ServerWorld) this.world).getEntityByUuid(this.higherPartUuid);
				if (entity instanceof LivingEntity) {
					this.higherPart = (LivingEntity) entity;
				}
			}
			return this.higherPart;
		}
		...
		protected void applyEntityAI(boolean flag) {
		}
