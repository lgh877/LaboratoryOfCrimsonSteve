...
@OnlyIn(Dist.CLIENT)
public class MrDummyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MrDummyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLMS_Human(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("laboratory:textures/mr_dummy.png");
					}
				};
			});
		}
	...
	public static class ModelLMS_Human extends EntityModel<Entity> {
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			...
			this.Head.rotationPointX = (float) ((Math.random() - 0.5) * entity.hurtTime);//This is for motion
			this.Body.rotationPointX = (float) ((Math.random() - 0.5) * entity.hurtTime);//This is for motion
		}
	}
}
