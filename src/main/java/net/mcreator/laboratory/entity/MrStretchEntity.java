...
import net.mcreator.laboratory.entity.renderer.MrStretchRenderer;
import net.mcreator.laboratory.LaboratoryModElements;

@LaboratoryModElements.ModElement.Tag
public class MrStretchEntity extends LaboratoryModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("mr_stretch").setRegistryName("mr_stretch");

	public MrStretchEntity(LaboratoryModElements instance) {
		super(instance, 20);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MrStretchRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711936, -3342490, new Item.Properties().group(MobsOfLaboratoryItemGroup.tab))
				.setRegistryName("mr_stretch_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 5, false, false, (p_234199_0_) -> {
				return !(p_234199_0_ instanceof MrStretchEntity.CustomEntity);
			}));
		...
		public void livingTick() {
			...
			if (this.getHealth() / this.getMaxHealth() <= 0.2)
				this.setBoundingBox((new AxisAlignedBB(this.getPosX() - 0.3D, this.getPosY(), this.getPosZ() - 0.3D, this.getPosX() + 0.3D,
						this.getPosY() + 1.3D, this.getPosZ() + 0.3D)));
			else {
				this.setBoundingBox((new AxisAlignedBB(this.getPosX() - 0.3D, this.getPosY(), this.getPosZ() - 0.3D, this.getPosX() + 0.3D,
						this.getPosY() + 1.9D, this.getPosZ() + 0.3D)));
			}
		}
