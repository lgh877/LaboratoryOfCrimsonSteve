...
import net.mcreator.laboratory.entity.renderer.IllagerAnimationMobRenderer;
import net.mcreator.laboratory.LaboratoryModElements;

@LaboratoryModElements.ModElement.Tag
public class IllagerAnimationMobEntity extends LaboratoryModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.8f, 2.7f)).build("illager_animation_mob").setRegistryName("illager_animation_mob");

	public IllagerAnimationMobEntity(LaboratoryModElements instance) {
		super(instance, 66);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IllagerAnimationMobRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13369549, -6750055, new Item.Properties().group(MobsOfLaboratoryItemGroup.tab))
				.setRegistryName("illager_animation_mob_spawn_egg"));
	}
