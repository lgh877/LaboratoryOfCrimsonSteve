...
import net.mcreator.laboratory.procedures.HomingProjectileLauncherWhileProjectileFlyingTickProcedure;
import net.mcreator.laboratory.entity.renderer.HomingProjectileLauncherRenderer;
...
public class HomingProjectileLauncherItem extends LaboratoryModElements.ModElement {
	@ObjectHolder("laboratory:homing_projectile_launcher")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybullethoming_projectile_launcher").setRegistryName("entitybullethoming_projectile_launcher");

	public HomingProjectileLauncherItem(LaboratoryModElements instance) {
		super(instance, 54);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HomingProjectileLauncherRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("homing_projectile_launcher");
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("laboratory:nope")), SoundCategory.PLAYERS,
