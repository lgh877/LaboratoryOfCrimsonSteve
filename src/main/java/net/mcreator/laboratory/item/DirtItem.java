...
public class DirtItem extends LaboratoryModElements.ModElement {
	@ObjectHolder("laboratory:dirt")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void tick() {
			...
			Entity imediatesourceentity = this;
			{
				...
				DumbFaceParticleSpawnProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
