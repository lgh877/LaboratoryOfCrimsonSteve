 ...
 *
 *    Keep the LaboratoryModElements object in this class and all calls to this object
...
@Mod("laboratory")
public class LaboratoryMod {
	public static final Logger LOGGER = LogManager.getLogger(LaboratoryMod.class);
	...
	public LaboratoryMod() {
		...
		MinecraftForge.EVENT_BUS.register(new LaboratoryModFMLBusEvents(this));
	}
