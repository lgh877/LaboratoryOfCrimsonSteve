...
@OnlyIn(Dist.CLIENT)
public class ChimeraTableGUIGuiWindow extends ContainerScreen<ChimeraTableGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 105, this.guiTop + 7, 60, 20, new StringTextComponent("Create!"), e -> {
			if (true) {
				LaboratoryMod.PACKET_HANDLER.sendToServer(new ChimeraTableGUIGui.ButtonPressedMessage(0, x, y, z));
				ChimeraTableGUIGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
